...
Task:
    ...
    - Use the same colorbar range for all subplots
    
Example command:
    python plot_phase_shift.py --sample_index 5 --cbar_step 0.1
    python plot_phase_shift.py --sample_index 0 --y_idx 22
    python plot_phase_shift.py --sample_index 0 --vmax 0.15
    python plot_phase_shift.py --sample_index 5 --cbar_step 0.2
...
def plot_hovmoller_error_row(
    ...
    out_svg = out_dir / f"sample{sample_index + 1:02d}_hovmoller_error_row_y{y_idx}.svg"
...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.05,
        help="Shared colorbar tick interval."
    )
    parser.add_argument(
        "--vmax",
        type=float,
    ...
    parser.add_argument(
        ...
        type=str,
        default="RdBu_r",
        help="Colormap for signed error."
    )
    parser.add_argument(
        "--interpolation",
        type=str,
