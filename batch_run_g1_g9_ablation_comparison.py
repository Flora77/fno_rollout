...
Place this file in the NEURALOPERATOR project root, then run for example:
    ...
    python batch_run_g1_g9_ablation_comparison.py --only G6 G7 G8 G9 --dry_run
...
G8  ConvLSTM+ no curriculum rollout + no added loss
G9  ConvLSTM+ direct 60 -> 300 prediction, no external rollout training
...
def build_experiments(layout: ScriptLayout) -> List[ExperimentSpec]:
    ...
    return [
        ...
        ExperimentSpec(
            ...
            model_arch="fno",
            experiment_name="G6_fno_direct60to60_no_rollout_no_added_loss",
            input_steps=60,
            output_steps=60,
            rollout_steps=60,
        ...
        ExperimentSpec(
            ...
            model_arch="msfno",
            experiment_name="G7_msfno_direct60to60_no_rollout_no_added_loss",
            input_steps=60,
            output_steps=60,
            rollout_steps=60,
            rollout_train_steps=DIRECT_STEPS,
        ...
        ExperimentSpec(
            ...
            model_arch="fno",
            experiment_name="G8_fno_direct60to300_no_rollout_no_added_loss",
            input_steps=60,
            output_steps=300,
            rollout_steps=300,
            rollout_train_steps=DIRECT_STEPS,
        ...
        ExperimentSpec(
            ...
            model_arch="msfno",
            experiment_name="G9_msfno_direct60to300_no_rollout_no_added_loss",
            input_steps=60,
            output_steps=300,
            rollout_steps=300,
            rollout_train_steps=DIRECT_STEPS,
