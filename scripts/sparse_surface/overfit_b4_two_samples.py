#!/usr/bin/env python3
"""Overfit B4 Mask U-Net on two real normalized 60-frame training windows."""
...
from neuralop.models.reconstructors import PeriodicMaskUNet
...
def main() -> int:
    ...
    model = PeriodicMaskUNet().to(device)
    ...
    initial = float(pretrainer.validate_batch(batch)["losses"]["total"].cpu())
    ...
    return 0 if summary["all_losses_finite"] and final < initial * 0.5 else 1
