...
def parse_args():
    parser = argparse.ArgumentParser(description="Detailed test export for sea-surface rollout.")
...
def main() -> None:
    ...
    loggers = build_pl_loggers(cfg, stage="test")
    ...
    print(f"Test export finished. CKPT={ckpt_path}")
    print(f"Saved MAT to: {mat_path}")
    print(f"Saved plots to: {os.path.join(cfg['paths']['plot_dir'], 'test')}")
