...
if __name__ == "__main__":
    # Usage:
    #   python validate_sea_surface_rollout_per_mat.py       # defaults to val
    #   python validate_sea_surface_rollout_per_mat.py val
    #   python validate_sea_surface_rollout_per_mat.py test
